/* Autor:Oscar Eduardo FLetes Ixta, 07/04/22
	...
	Programa en lenguaje c, que utilizando la misma estructura y menu del prog_est_prog2_9, solo agregamos al menu las opciones 
	guardar archivo, cargar archivo y ordenamineto por nombre, con el uso de estructuras, prototipos de funciones, switch, uso de milibreria.h
	...
	porcentaje de los alumnos aprobados, gardar archivo, cargar archivo y ordenar por nombre. al seleccionar la opcon 1(agregar) pide 3 variable del tipo char, 
	float, int(Nombre, promedio, faltas), se insertan, y ya se puede realizar lo demas del menu
	*/
...
void agregar(struct alumno x[]){//funcion agregar alumno(parametros)
